...
//}
    ...
    cpu->describeCapability("clflush", "CLFLUSH instruction");
    ...
    cpu->describeCapability("recovery", "CPU in recovery mode");
    ...
    cpu->describeCapability("cyrix_arr", "Cyrix ARRs (= MTRRs)");
    cpu->describeCapability("centaur_mcr", "Centaur MCRs (= MTRRs)");
    cpu->describeCapability("pni", "SSE-3");
    cpu->describeCapability("monitor", "MONITOR/MWAIT support");
